...
def announce_lead_changes(last_score_leader=None):
    ...
    def say(score0, score1):
        if score0 > score1:
            ...
            leader = None
        if leader != None and leader != last_score_leader:
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    >>> f5 = f4(20, 47) # Player 1 gets 17 points; not enough for a new running_high
    >>> f6 = f5(21, 47)
    >>> f7 = f6(21, 77)
...
def make_averaged(original_function, trials_count=1000,sum = 0):
    ...
    def f(*args):
        ...
        while count > 0:
            all += f(*args)
            count -= 1
        return all/trials_count
    return f 
    # END PROBLEM 8


def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    """Return the number of dice (1 to 10) that gives the running_highest average turn
    ...
    rolls = 1
    highest_scores = 0
    while rolls <= 10 and rolls > 0:
        scores = make_averaged(roll_dice)(rolls,dice)
